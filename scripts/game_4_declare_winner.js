...
// run player2 expect error : "player does not exist"
async function main() {
  console.log("\ngame_4_declare_winner starting ...")
  let balance
  ...
  let player1Address = game_config['game_4_declare_winner']['player1Address']
  let player1Name = game_config['game_4_declare_winner']['player1Name']
  ...
  transaction = await gameContract.declareWinner(player1Address)
  tx = await transaction.wait()
  console.log("declareWinner event:", tx.events)
  ...
  console.log("\ngame_4_declare_winner completed successfully.")
}
